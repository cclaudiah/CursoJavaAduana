...
<% 
        ...
        servicio = (ServicioLocal) ctx.lookup("java:global/CursoJava/Servicio!cl.model.ServicioLocal");
    %>
		...
		<div class="col s6 offset-s3">
			<div class="card-panel z-depth-5">
				...
				<form action="control.do" method="post">
					...
					<button name="boton" type="submit" value="guardar" class="btn right">Guardar</button>
					<br>
					<br>
				</form>
